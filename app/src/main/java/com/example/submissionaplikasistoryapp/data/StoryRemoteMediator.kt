...
import com.example.submissionaplikasistoryapp.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    private val userPreference: UserPreferences?= null
    ...
    override suspend fun load(
        ...
        try {
            ...
            val responseData = apiService.getAllStories("Bearer $token", page, state.config.pageSize, 0 ).listStory
